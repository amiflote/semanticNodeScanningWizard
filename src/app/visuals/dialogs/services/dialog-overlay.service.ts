...
import { FilePreviewOverlayRef } from './dialog-overlay-ref';
import { ChooseObjectDialogComponent } from '../choose-object-dialog/choose-object-dialog.component';
...
export class FilePreviewOverlayService {
  ...
  private attachDialogContainer(overlayRef: OverlayRef, config: FilePreviewDialogConfig, dialogRef: FilePreviewOverlayRef) {
    ...
    const containerPortal = new ComponentPortal(ChooseObjectDialogComponent, null, injector);
    const containerRef: ComponentRef<ChooseObjectDialogComponent> = overlayRef.attach(containerPortal);
  ...
  private createInjector(config: FilePreviewDialogConfig, dialogRef: FilePreviewOverlayRef): PortalInjector {
    ...
    injectionTokens.set(MAT_DIALOG_DATA, config.image);
